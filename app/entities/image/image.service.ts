...
export class ImageService {
    ...
    findByProducto(idProducto: any, req?: any): Observable<HttpResponse<Image[]>> {
        const options = createRequestOption(req);
        return this.http.get<Image[]>(this.resourceUrl + `/findByProduct/${idProducto}`, { params: options, observe: 'response' })
            .map((res: HttpResponse<Image[]>) => this.convertArrayResponse(res));
    }
